...
The study used community-based collaboration to recruit a targeted sample of Mexican-origin adolescents, mothers, and fathers, contributing to a literature where fathers (particularly Latino fathers) have been largely missing. Through the innovative integration of both longitudinal (macro-time) and daily diary (micro-time) research design features, important questions about cause and effect, and how mediating and moderating processes unfold over time, will be addressed.

The proposed analyses also reflect the multi-layered sociocultural niches occupied by Latino adolescents by employing individual-level methods as well as dyadic (adolescent-mother; adolescent-father) and triadic (adolescent-mother-father) analyses to test key study hypotheses.

Visit [Seguimos Avanzando](https://shaw.nd.edu/research/seguimos-avanzando/) to learn more!
