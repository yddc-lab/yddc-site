...
- icon: door-open
  icon_pack: fas
  name: The BOBA Project
  url: https://www.thebobaproject.com/
---

The impact of discrimination on mental health is particularly salient to Asian American (AA) parents and children given the current social and political context. During the pandemic, covert and overt anti-Asian discrimination -- such as referencing COVID-19 as "China virus" or "Kung Flu," and physical assaults -- skyrocketed by 145% in 2020, and spiked by 164% in the first quarter of 2021 compared to the same period in 2020. From March 19, 2020 to March 31, 2021, a national bias reporting clearinghouse, "Stop AAPI Hate," received 6,603 reports of anti-Asian incidents, with 83.3% reflecting virulent animosity and 43.7% of reported incidents targeting Chinese individuals.
